...
<div class=""tele"">
  ...
  <div><span>Arquivos em contexto de fornecedor analisados:</span> {metrics.AnalyzedKnownVendorLocation}</div>
  <div><span>Degradações de cache:</span> {metrics.CacheDegradationEvents}</div>
