...
public class AppSettings
{
    ...
    // is true. There is no unsigned fallback. Additive optional
    ...
    [Obsolete("Unsigned signature updates were removed. This value is ignored and cleared during migration.")]
    ...
    private static AppSettings Migrate(AppSettings loaded, int fromVersion)
    {
        ...
        // P0 schema v2: retain the JSON property only so old files deserialize,
        // then discard it. It is never promoted into SignedUpdateFeedUrl and can
        // never become an implicit trust decision.
#pragma warning disable CS0618
        loaded.SignatureUpdateUrl = string.Empty;
