...
public class FileSystemSignatureUpdateSinkTests
{
    ...
    public void Commit_ProjectsMaliciousFeed_AndSignatureDatabaseReadsIt()
    {
        ...
        try
        {
            ...
            Assert.True(File.Exists(Path.Combine(root, FileSystemSignatureUpdateSink.MaliciousFeedFileName)));
    ...
    public void Commit_ProjectsAllowlistFeed_AndSignatureDatabaseReadsIt()
    {
        ...
        try
        {
            ...
            Assert.True(File.Exists(Path.Combine(root, FileSystemSignatureUpdateSink.SafeFeedFileName)));
    ...
    public void Commit_WritesYaraFeedRule()
    {
        ...
        try
        {
            ...
            var yaraFiles = Directory.GetFiles(Path.Combine(root, "yara_rules"), FileSystemSignatureUpdateSink.YaraFeedPrefix + "*.yar");
    ...
    public void SecondCommit_ReplacesHashFeed_AndRemovesStaleYara()
    {
        ...
        try
        {
            ...
            var yaraDir = Path.Combine(root, "yara_rules");
